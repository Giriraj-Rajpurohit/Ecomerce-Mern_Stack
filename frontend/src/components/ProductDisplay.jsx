...
import product_rt_1 from "../assests/product_rt_1.png";
import product_rt_2 from "../assests/product_rt_2.png";
import product_rt_3 from "../assests/product_rt_3.png";
import product_rt_4 from "../assests/product_rt_4.png";
    ...
    <section className='my-6'>
        <div className='flex flex-col gap-14 xl:flex-row'>
            ...
            <div className='flex-col flex xl:flex-[1.7]'>
                ...
                <div className='flex gap-x-6 medium-20 py-4'>
                ...
                <div className='mb-4'>
                    ...
                    <div className='flex flex-col gap-y-3 mb-4 max-w-[555px my-5'>
                        ...
                        <button className='btn_dark_rounded !rounded-none uppercase regular-14 tracking-widest'>But Now</button>
                    </div>
